...
class HuebnerCobolt06mld:
    ...
    def get_status(self) -> int:
        """Gets the current status of the laser. It can be on (1) or off (0)
    ...
    def set_status(self, status: int) -> None:
        """Sets the current status of the laser. It can be on (1) or off (0)

        Parameters
        ----------
        status : int
            new status of the laser

        Raises
        ------
        ValueError
            If the value of parameter status is not 0 or 1
    ...
    def get_analog_modulation_state(self) -> int:
        """Gets the current analog modulation state of the laser. It can be on (1) or off (0)

        Returns
        -------
        int
            analog modulation state of the laser
        """
    ...
    def set_analog_modulation_state(self, analog_modulation_state: int) -> None:
        ...
        Parameters
        ----------
        analog_modulation_state : int
            new analog modulation state of the laser

        Raises
        ------
        ValueError
            If the value of parameter analog_modulation_state is not 0 or 1
